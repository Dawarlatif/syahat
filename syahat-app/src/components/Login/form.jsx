...
const Form = () => {
  return (
    <div className=' rounded-xl md:w-3/4 w-4/5 flex-col flex md:flex-row  bg-white px-4 py-6 md:p-4 divide-y-2 md:divide-x-2 '>
    <div className='w-full md:w-1/2  flex flex-wrap flex-col mx-auto md:mx-4 justify-center '>
    <div className=' w-full border items-center text-center mx-auto rounded-xl px-1 md:px-2 2xl:px-4'>
